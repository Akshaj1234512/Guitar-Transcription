...
hf download <ANON>/audio_to_midi_guitar --local-dir audio_to_midi
hf download <ANON>/expressive-techniques-guitar --local-dir expressive-techniques-guitar
hf download <ANON>/audiofret --local-dir string-fret
```
...
```bash
hf download <ANON>/audio_to_midi_guitar --local-dir audio_to_midi --max-workers 1
hf download <ANON>/expressive-techniques-guitar --local-dir expressive-techniques-guitar --max-workers 1
hf download <ANON>/audiofret --local-dir string-fret --max-workers 1
```

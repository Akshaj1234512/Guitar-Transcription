...
def main():
    ...
    parser.add_argument('--train_dir', type=Path, default=Path('./data/unified_dataset_v2_plus_augmentation/train'))
    ...
    parser.add_argument('--test_dir', type=Path, default=Path('./data/unified_dataset_v2/test'))
